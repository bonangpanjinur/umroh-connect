-- ==========================================
-- SETUP MANAGEMENT HALAMAN (PAGES)
...
-- 3. Kebijakan RLS untuk Tabel Pages
-- Publik bisa melihat halaman yang aktif, Admin bisa mengelola semuanya
...
-- 4. Setup Storage Bucket untuk Gambar Halaman
INSERT INTO storage.buckets (id, name, public) 
VALUES ('page-images', 'page-images', true)
ON CONFLICT (id) DO NOTHING;

-- 5. Kebijakan Storage untuk Bucket page-images
...
-- Pastikan fungsi handle_updated_at() sudah ada (biasanya standar di Supabase)
