...
const required = [
  ...
  'supabase/migrations/20260908090000_harden_lead_credential_scopes.sql',
  'supabase/migrations/20260908093000_add_lead_claim_timeout_index.sql',
...
const checks = [
  ...
  ['claim timeout requeue', 'supabase/functions/lead-routing/index.ts', /CLAIM_TIMEOUT/],
  ['ack claimed guard', 'supabase/functions/lead-routing/index.ts', /eq\('status', 'claimed'\)/],
